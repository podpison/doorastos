...
const Item: FC<Props> = ({ description, heading, className, itemClassName, headingClassName }) => {
  ...
  return <div className={cn('flex flex-col gap-y-2.5', className)}>
    {heading && <h6 className={cn('', headingClassName ? headingClassName : 'text-[14px] md:text-[18px]')}>{heading}</h6>}
